...
koreanTexts = {
    ...
    newRatingLabel = { fonts.FriendsFont, colors.white, "TOPRIGHT", -119, -13, "" },
    timestampLabel = { fonts.FriendsFont, colors.white, "TOPRIGHT", -49, -13, "" },
    winnerLabel = { fonts.FriendsFont, colors.white, "LEFT", 0, 0, "손실" },
    vsTextEntry = { fonts.FriendsFont, colors.white, nil, 178, -13, "VS" },
...
chineseChinaTexts = {
    ...
    newRatingLabel = { fonts.FriendsFont, colors.white, "TOPRIGHT", -119, -13, "" },
    timestampLabel = { fonts.FriendsFont, colors.white, "TOPRIGHT", -49, -13, "" },
    winnerLabel = { fonts.FriendsFont, colors.white, "LEFT", 0, 0, "失利" },
    vsTextEntry = { fonts.FriendsFont, colors.white, nil, 178, -13, "VS" },
...
russianTexts = {
    ...
    winnerLabel = { fonts.FriendsFont, colors.white, "LEFT", -5, 0, "потеря" },
    vsTextEntry = { fonts.FriendsFont, colors.white, nil, 178, -13, "VS" },
    noGames = { fonts.gameFontVeryBig, colors.grey, "CENTER", 0, 0, "Игр не зарегистрировано" },
    playerClassSpec = { fonts.gameFontRegularShadow, colors.grey, "CENTER", 0, -5, "" },
    playerName = { fonts.fancyFontRegular, colors.white, "CENTER", 0, 13, "" },
    highestHeaderLabel = { fonts.gameFontRegularShadow, colors.light, "CENTER", 0, 18, "Высокий сезон" },
    seasonHighLabel = { fonts.fancyFontSmall, colors.white, "CENTER", 0, 0, "" },
    twosHighestLabel = { fonts.gameFontRegularShadow, colors.light, "CENTER", 0, 18, "2v2" },
    twosHighestDetail = { fonts.fancyFontSmall, colors.white, "CENTER", 0, 0, "" },
    threesHighestLabel = { fonts.gameFontRegularShadow, colors.light, "CENTER", 0, 18, "3v3" },
...
textInsertsRussian = {
    ...
    errorCorruptionGame = "Коррумпированный состав команды, поэтому Rated не спасла игру. (Вы играли 2 на 3/1 на 2 и т. Д.?)",
    ...
    headerOneWin = "1 выиграть",
    headerOneLoss = "1 потеря",
    headerWins = " выигрывает",
    headerLosses = " убытки",
    winGameLabel = "Выиграть",

    -- Tooltip info game entry
    tooltipFinishedLabel = "Эта игра была закончена и записана в ",
    tooltipFinishedDateInterval = " на ",
    tooltipUnratedName = "Честь",
    tooltipYourTeamLabel = "Твоя команда",
    tooltipEnemyTeamLabel = "Команда противника",
    tooltipDamage = " повреждать",
    tooltipHealing = " выздоровление",
    tooltipBracket = "скобка",
    tooltipMapAndMatch = "Данные карты и сопоставления|r",
    mapStatsFull = "\nНачинать: \nЗакончено: \nПродолжительность:\nСоотношение выигрышей и проигрышей: |r",
    mapStatsSmall = "\nЗакончено: \nСоотношение выигрышей и проигрышей: |r",
    tooltipTalents = "Таланты|r",
    tooltipTrinkets = "Ваши безделушки|r",
    ...
    prefixTitle = "звание: ",
    prefixHighest = "Наибольший: ",
    prefixPlayed = "Играл: ",
    prefixWon = "Победил: ",
    prefixLost = "Потерянный: ",
    prefixRating = "Рейтинг: ",
    tooltipNameLabel = "Имя: ",
    tooltipNumberLabel = "Число: ",
    tooltipExpansionLabel = "Расширение: ",
    tooltipHighestTitle = "Высший титул: ",
    tooltipSeasonHighest = "Высокий сезон: ",
    tooltipWeeklyHighest = "Еженедельный максимум: ",

    prefixCurrent = "Текущий|r",
    prefixSeason = "Время года|r",
...
frenchTexts = {
    ...
    newRatingLabel = { fonts.FriendsFont, colors.white, "TOPRIGHT", -119, -13, "" },
    timestampLabel = { fonts.FriendsFont, colors.white, "TOPRIGHT", -49, -13, "" },
    winnerLabel = { fonts.FriendsFont, colors.white, "LEFT", 0, 0, "Perte" },
    vsTextEntry = { fonts.FriendsFont, colors.white, nil, 178, -13, "VS" },
